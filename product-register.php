        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <form id="productForm" enctype="multipart/form-data" class="p-8">
                <div class="mb-6">
                    ...
                    <input type="text" name="productTitle" id="productTitle" placeholder="Enter product title" maxlength="150" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition" />
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="5" placeholder="Describe your product in detail.." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition" maxlength="1000" required></textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price" id="price" placeholder="0.00" min="0" step="0.01" class="w-full pl-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <select name="level" id="level" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition">
                ...
                <div class="mb-8">
                    ...
                    <div id="uploadArea" class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-colors">
                        <svg class="mx-auto h-12 w-12 text-gray-400 mb-2" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                            <path d="M28 8H12a4 4 0 00-4 4v20a4 4 0 004 4h24a4 4 0 004-4V20m-6-8l-6-6m0 0l-6 6m6-6v12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    ...
                    <div id="imagePreview" class="mt-6 hidden">
                        <img src="" id="previewImg" alt="Preview" class="max-w-xs h-auto rounded-lg shadow-md mb-4"/>
                ...
                <div class="flex gap-4">
                    <button type="submit" class="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-105">Register Product</button>
                    <a href="seller-dashboard.php" class="flex-1 bg-gray-300 text-gray-800 font-semibold py-3 rounded-lg hover:bg-gray-400 transition-colors text-center">Cancel</a>
                </div>
            </form>
        </div>
    </div>
