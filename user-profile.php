...
$userResult = Database::search(
   "SELECT u.`id`,u.`fname`,u.`lname`,u.`email`,u.`active_account_type_id` FROM `user` u  WHERE u.`id`=?","i",[$userId]
);
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Page Header -->
         ...
         <!-- Success/Error Message -->
          <?php if($profileMsg):?>
    <div id="alertBox" class="mb-6 p-4 rounded-lg <?php echo strpos($profileMsg, "success") !== false ? "bg-green-50 border border-green-200" : "bg-red-50 border border-red-200";?>">
            ...
            <!-- Avatar Section -->
             ...
             <!-- Basic Information -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <!-- First Name -->
                     <div>
                        ...
                        <input type="text" id="fanme" name="fname" value="<?php echo $user["fname"]; ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"/>
                     ...
                     <div>
                        ...
                        <input type="text" id="lname" name="lname" value="<?php echo $user["lname"]; ?>" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"/>
                        <span class="error text-red-500 text-sm hidden"></span>
                     </div>
                     <!-- Email-->
                     <div class="sm:col-span-2">
                        <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                        <input type="email" id="email" name="email" value="<?php echo $user["email"]; ?>" required readonly class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus-ring-blue-500 focus:border-transparent outline-none transition"/>
                        <span class="error text-red-500 text-sm hidden"></span>
                     </div>
                </div>
              </div>
              <!-- Profile Information -->
                ...
                <div class="space-y-6">
                    <!-- Bio -->
                     <div>
                        ...
                        <textarea name="bio" id="bio" rows="4" placeholder="Tell us about yourself..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:boder-transparent outline-none transition"><?php echo $profile ? $profile["bio"] : ""; ?></textarea>
                     ...
                     <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <!-- Gender -->
                         <div>
                            ...
                            <select name="genderId" id="genderId" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition">
                         ...
                         <!-- Mobile -->
                          <div>
                            ...
                            <input type="tel" id="mobile" placeholder="10 digits" value="<?php echo $profile ? $profile["mobile"] : "";?>"pattern="[0-9]{10}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"/>
               ...
               <!-- Address Information -->
                <div class="bg-white rounded-lg shadow-lg shadow p-6">
                    ...
                    <div class="space-y-6">
                        <!-- Address Line 1 -->
                         <div>
                            ...
                            <input type="text" name="line1" id="line1" value="<?php echo $profile ? $profile["line1"] : "";?>" placeholder="street address" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition">
                             <span class="error text-red-500 text-sm hidden"></span>
                         </div>
                          <!-- Address Line 2 -->
                         <div>
                         ...
                         <div>
                            ...
                            <select name="countryId" id="countryId" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border bg-transparent outline-none transition">
                         ...
                         <div>
                            ...
                            <select name="cityId" id="cityId" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border bg-transparent outline-none transition">
                ...
                <!-- Form Actions -->
                 <div class="flex gap-4 justify-end">
                    <a href="<?php echo $userRole =="buyer"? "buyer-dashboard.php" : "seller-dashboard.php";?>" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors">Cancel</a>
