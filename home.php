...
<!--Hero section-->
<section class="bg-gradient-to-r from-indigo-500 to-blue-600 text-white py-16 md:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 gap-8 items-center">
            <div class="">
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Learn & Earn skill today</h1>
                <p class="text-blue-100 text-lg mb-6">Connect with experet skill sellers and buyer in pur thriving
                    community</p>
                ...
                <div class="flex gap-4 flex-col md:flex-row">
                    ...
                    font-bold hover:bg-white hover:bg-opacity-10 inline-block transition-all">Brows Skills</a>
                        <?php endif; ?>
                    ...
                    font-bold hover:shadow-lg inline-block transition-all">Get Start</a>
                        <a href="#brows" class="border-2 border-white text-white px-6 py-3 rounded-lg
                    font-bold hover:bg-white hover:bg-opacity-10 inline-block transition-all">Lern More</a>
            ...
            <div class="hidden md:block">
                <div class="bg-white bg-opacity-10 rounded-xl p-8 backdrop-blur-sm">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3 text-blue-100">
                            <span class="text-2xl">🚀</span>
                            <p>Grow youre skills or business</p>
                        </div>
                        <div class="flex items-center gap-3 text-blue-100">
                            <span class="text-2xl">💰</span>
...
<section id="browse" class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-12">
        ...
        <p class="text-gray-600">Discover trending skills fron top sellers</p>
    </div>
        ...
        <div class="overflow-hidden rounded-xl">
            <div id="carousel" class="flex transition-transform duration-500 ease-out"
                ...
                <?php else: ?>
                    <!-- NO product message -->
                    <div class="carousel-item flex-shrink-0 w-full md:w-1/3 px-3 pb-4">
                        <div class="bg-white rounded-xl overflow-hidden shadow-lg p-8 text-center h-full flex item-center">
    ...
    <div id="carousel-indicators" class="flex justify-center gap-2 mt-8">
        <button ondblclick="goToSlide(0);"
            class="carousel-dot w-3 h-3 rounded-full bg-blue-600 transition-all"></button>
        <button ondblclick="goToSlide(1);"
            class="carousel-dot w-3 h-3 rounded-full bg-gray-300 transition-all"></button>
    </div>

</section>

<!--Category section-->
<section id="cateegories" class="bg-gray-50 py-16 md:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                <div class="text-5xl mb-3 group-hover:scale-110 transitio-transform">🎨</div>
                <p class="font-semibold texxt-gray-800 group-hover:text-blue-600">Design</p>
            </a>

            <a href="" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow:lg transition-all
        cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                <div class="text-5xl mb-3 group-hover:scale-110 transitio-transform">💻</div>
                <p class="font-semibold texxt-gray-800 group-hover:text-blue-600">Development</p>
            </a>

            <a href="" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow:lg transition-all
        cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                <div class="text-5xl mb-3 group-hover:scale-110 transitio-transform">📱</div>
                <p class="font-semibold texxt-gray-800 group-hover:text-blue-600">Mobile</p>
            </a>

            <a href="" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow:lg transition-all
        cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                <div class="text-5xl mb-3 group-hover:scale-110 transitio-transform">📚</div>
                <p class="font-semibold texxt-gray-800 group-hover:text-blue-600">Education</p>
            </a>

            <a href="" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow:lg transition-all
        cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                <div class="text-5xl mb-3 group-hover:scale-110 transitio-transform">🎬</div>
                <p class="font-semibold texxt-gray-800 group-hover:text-blue-600">Video</p>
            </a>

            <a href="" class="group bg-white p-6 rounded-lg text-center shadow hover:shadow:lg transition-all
        cursor-pointer hover:scale-105 hover:border-2 hover:border-blue-600">
                <div class="text-5xl mb-3 group-hover:scale-110 transitio-transform">💼</div>
                <p class="font-semibold texxt-gray-800 group-hover:text-blue-600">Business</p>
            </a>
        </div>
    </div>
</section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <?php foreach ($testimonials as $idx => $testimonial): ?>
                <div class="bg-white rounded-lg shadow-lg p-8 hover:shadow-2xl transition-shadow hover:scale-105 duration-300">
                    <div class="flex items-center mb-4">
                        ...
                        <div class="">
                            <p class="font-bold text-gray-900"><?php echo $testimonial["fname"] . "" . $testimonial["lname"]; ?>
                            </p>
                            <p class="text-sm text-yelloe-400">
                                <?php
                                $stars = '';
        ...
        <?php else: ?>
            <div class="bg-white rounded-lg shadow-lg p-8 text-center col-span-3">
                <p class="text-gay-500">NO testtimonial yet. Be the first to leave a review</p>
            </div>
        <?php endif; ?>
    </div>
</section>
...
<section class="py-16 md:py-24 bg-gradient-to-r from-indigo-500 to-blue-600 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<section class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <h2 class="text-3xl mb:text-4xl font-bold-text-gray-900 mb-12 text-center">How It Work</h2>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="text-center group">
            <div class="bg-gradient-to-r from-indigo-500 to-blue-600 rounded-full w-16 h-16 flex items-center
            ...
            <p class="text-gray-600 text-sm">Sign up as a aeller in minutess</p>
        </div>
        <div class="text-center group">
            <div class="bg-gradient-to-r from-indigo-500 to-blue-600 rounded-full w-16 h-16 flex items-center
            justify-center text-2xl text-white mx-auto mb-4 group-hover:scale-110 transition-transform">2</div>
            <h3 class="font-bold text-lg text-gray-900 mb-2">Brows or List</h3>
            <p class="text-gray-600 text-sm">Explore Skills or create youre own content</p>
        </div>
        <div class="text-center group">
            <div class="bg-gradient-to-r from-indigo-500 to-blue-600 rounded-full w-16 h-16 flex items-center
            ...
            <p class="text-gray-600 text-sm">Intract with instructors and commiunity</p>
        </div>
        <div class="text-center group">
            <div class="bg-gradient-to-r from-indigo-500 to-blue-600 rounded-full w-16 h-16 flex items-center
            justify-center text-2xl text-white mx-auto mb-4 group-hover:scale-110 transition-transform">4</div>
            <h3 class="font-bold text-lg text-gray-900 mb-2">Grows or List</h3>
...
<section class="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-indigo-500 to-blue-600 rounded-2xl p-8 md:p-16 text-center text-white shadow-2xl">
        <h2 class="text-3xl md:text-4xl font-bold mb-4">Redy to start youre Joruney?</h2>
        <p class="text-blue-100 text-lg mb-8">Joind thousands of lesrners and sellers earning on skillshop today</p>
        <div class="flex flex-col md:flex-row gap-4 justify-center">
            <?php if (isset($_SESSION["user_email"])): ?>

                <?php if ($userRole == "buyer"): ?>
                    <a href="buyer-dashboard" class="bg-white text-blue-600 px-8 py-3 rounded-lg font-bold
                hover:shadow-2xl inline-block transition-all hover:scale-105">Goto dashboard</a>

                    <a href="#brows" class="border-2 border-white text-white px-8 py-3 rounded-lg font-bold
